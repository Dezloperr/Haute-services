...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-background text-primary font-paragraph selection:bg-gold-accent selection:text-white overflow-clip">
      ...
      {/* --- HERO SECTION --- */}
      <section className="relative min-h-screen flex flex-col justify-center pt-12 sm:pt-20 pb-8 sm:pb-12">
        {/* Background Elements */}
            ...
            <div className="lg:col-span-8">
              ...
              <div className="grid md:grid-cols-2 gap-8 sm:gap-12">
                ...
                <AnimatedElement delay={400} className="relative mt-8 sm:mt-12 md:mt-0">
                  <div className="aspect-video bg-gray-100 bg-[url(https://static.wixstatic.com/media/e86273_733e8cac0d2a4461b6e62be12e290674~mv2.jpg)] bg-top overflow-hidden">
                  </div>
                </AnimatedElement>
              </div>
            </div>
