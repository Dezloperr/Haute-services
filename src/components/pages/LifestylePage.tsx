...
// Book authors data
const bookAuthors = [
  { name: 'Abhijit Saha', role: 'Food Author', image: 'https://static.wixstatic.com/media/e86273_2fe0218bfef0411ca55155a1c607750b~mv2.png?originWidth=128&originHeight=128' },
  { name: 'Vicky Ratnani', role: 'Food Author', image: 'https://static.wixstatic.com/media/e86273_2e4445ba5c244a3c946825482e316269~mv2.png?originWidth=128&originHeight=128' },
  { name: 'Asma Khan', role: 'Food Author', image: 'https://static.wixstatic.com/media/e86273_ce46e0e14b1e4765964e88c13a18889a~mv2.png?originWidth=128&originHeight=128' },
  { name: 'Rukni Rana', role: 'Food Author', image: 'https://static.wixstatic.com/media/e86273_01f46e89b380484ea5080bbe050d9cb0~mv2.png?originWidth=128&originHeight=128' },
];
        ...
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 lg:px-12">
          <div className="text-center mb-8 sm:mb-20">
            ...
            <p className="font-paragraph text-base sm:text-lg lg:text-xl text-secondary max-w-3xl mx-auto px-4">
              Celebrating culinary excellence and literary voices in the food world.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-24 lg:py-32">
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="lg:col-span-4 mb-12">
                ...
                <h2 className="font-heading text-xl sm:text-4xl lg:text-5xl text-secondary uppercase tracking-widest font-medium mb-4 sm:mb-8">
              Featured Food Authors
            </h2>
            <p className="font-paragraph text-base sm:text-lg text-secondary max-w-3xl">
              We celebrate the voices of renowned food authors who have launched their books through our platform, sharing their culinary expertise and stories with the world.
            </p>
            </div>

          {/* Book Authors Marquee */}
          <div className="w-full overflow-hidden bg-gray-50 py-10 mb-12 sm:mb-20">
            <motion.div
        ...
        <div className="max-w-[100rem] mx-auto px-4 sm:px-6 lg:px-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-24 items-start mb-12 sm:mb-20">
            ...
            <div>
              ...
              >
                <button className="bg-secondary text-secondary-foreground border-none rounded px-4 sm:px-6 py-2 sm:py-3 font-paragraph text-sm sm:text-base hover:opacity-90 transition-opacity flex items-center gap-2">
          ...
          <div className="grid lg:grid-cols-12 gap-8 sm:gap-12">
            ...
            <div className="lg:col-span-4">
              <div className="lg:sticky lg:top-32">
                  ...
                  <div className="hidden lg:block w-24 h-px bg-secondary" />
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6 sm:gap-8">
                {values.map((value, idx) => (
                  <div 
                    ...
                    className={`bg-white p-6 sm:p-10 border border-gray-100 hover:border-secondary/30 transition-colors duration-300 md:col-span-2 md:w-1/2`}
                  >
                    <value.icon className="w-8 h-8 text-secondary mb-6" strokeWidth={1.5} />
