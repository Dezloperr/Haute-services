            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              {leadership.map((leader) => (
                <div key={leader._id} className="bg-white">
                  ...
                  {leader.title && (
                    <p className="font-paragraph text-lg text-gold-accent mb-6">
                      {leader.title}
                    </p>
                  )}
                  {leader.bio && (
        ...
        <div className="max-w-[100rem] mx-auto px-12">
          ...
          {clients.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
              {clients.map((client) => (
                <div key={client._id} className="bg-white p-8 text-center">
                  {client.clientLogo && (
                  ...
                  {client.projectType && (
                    <p className="font-paragraph text-base text-gold-accent mb-4">
                      {client.projectType}
                    </p>
                  )}
                  ...
                  {client.clientWebsiteUrl && (
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-block mt-4 font-paragraph text-base text-foreground hover:text-gold-accent transition-colors"
                    >
                      Visit Website →
                    </a>
                  )}
