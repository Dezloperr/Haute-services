      ...
      <section className="w-full max-w-[120rem] mx-auto px-4 sm:px-6 border-b lg:px-12 pt-12 sm:pt-32 pb-12 sm:pb-16">
        ...
        >
          ...
          <p className="font-paragraph text-base sm:text-lg lg:text-xl text-center text-secondary leading-relaxed">
            <span className="italic">Where culinary excellence meets artistic vision.</span> <br /> We are a boutique consultancy specializing in food, art, and hospitality experiences that transcend the ordinary.
          </p>
        </motion.div>
      </section>
