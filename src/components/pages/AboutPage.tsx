  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="w-full max-w-[120rem] mx-auto px-4 sm:px-6 border-b lg:px-12 pt-12 sm:pt-32 pb-12 sm:pb-16">
        ...
        >
          <h1 className="font-heading text-3xl sm:text-5xl md:text-6xl lg:text-7xl text-foreground mb-4 sm:mb-6">
          ...
          <p className="font-paragraph flex flex-col gap-2 text-base sm:text-lg lg:text-xl text-center text-secondary leading-relaxed">
            <span className="italic text-sm whitespace-nowrap text-gold-accent/80">Where culinary excellence meets artistic vision.</span> <br /> We are a boutique consultancy specializing in food, art, and hospitality experiences that transcend the ordinary.
          </p>
        </motion.div>
      </section>
